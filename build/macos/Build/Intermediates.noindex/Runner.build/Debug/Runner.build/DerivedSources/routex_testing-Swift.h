...
#ifndef ROUTEX_TESTING_SWIFT_H
#define ROUTEX_TESTING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="routex_testing",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14routex_testing11AppDelegate")
...
SWIFT_CLASS("_TtC14routex_testing17MainFlutterWindow")
